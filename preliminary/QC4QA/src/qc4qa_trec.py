...
# Download the model and word vectors at
...
PATH_TO_W2V = './SentEval/glove.840B.300d.txt'  # path to your glove file
MODEL_PATH = './SentEval/infersent1.pkl'  # path to your infersent model
